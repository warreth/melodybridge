...
public class ArchiveOrgDownloaderLiveTests
{
    ...
    public async Task Search_WellKnownRecording_FindsDirectMp3Url()
    {
        ...
        var hit = await _downloader.SearchAsync("Johanne Stockmarr", "Für Elise", MelodyBridge.Core.DownloadQuality.Any);
    ...
    {
        var hit = await _downloader.SearchAsync("zzzxqj", "qqqwwwzzz nonexistent track 999", MelodyBridge.Core.DownloadQuality.Any);
